package com.zerojump.a18app.investor.ui.profile
...
class ProfileInvestorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            userGoogle?.let{
                ...
                Glide.with(this@ProfileInvestorFragment).load(it.photoUrl).into(cv_profile)
            }
        }catch (e :Exception){
